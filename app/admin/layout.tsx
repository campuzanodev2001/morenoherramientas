...
const navItems = [
  ...
  { href: '/admin/hero', label: 'Hero', icon: 'image', exact: false },
  { href: '/admin/reportes', label: 'Reportes', icon: 'bar_chart', exact: false },
]
    ...
    <div className="min-h-screen">
      ...
      >
        <div className="p-4 border-b border-white/10">
          ...
          <h1 className="text-on-primary text-base font-black uppercase mt-2 tracking-tight">
            Panel Admin
          </h1>
      ...
      <div className="flex flex-col md:ml-64 min-h-screen">
        <div className="md:hidden bg-primary-container flex items-center gap-3 px-4 py-3 sticky top-0 z-20">
          ...
          <span className="text-on-primary font-black text-sm uppercase tracking-tight">
            Panel Admin
          </span>
        </div>
